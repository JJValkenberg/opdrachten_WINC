...
let colors = ['blauw', 'groen', 'rood', 'geel']

let greeting = {
    hallo: 'Hi, ik ben een nieuw object!'
};
...
console.log("Energie level kat 3", catBreeds[0].energy_level);

console.log("1e temperament kat 2", catBreeds[1].temperament[0]);

console.log("temperamenten kat 3", catBreeds[2].temperament[4]);
